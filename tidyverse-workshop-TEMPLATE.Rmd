...
```{r}
#select just the columns "name" and "ski_days"
...
#most to least ski days 
ordered_num_skidays <- tidy_beaver %>% 


# [hint: for descending alphabetical order, use desc() or "-sorting_variable" syntax]
```
...
# use mutate() to convert ski_days to hours on the slopes and days/month
   # assuming there are 4 months in the season
   # and 7 hours of skiing per day (no tailgating??)
skidays_per_month <- tidy_beaver %>% 
